...
module Admin
  # ParkSystemsController
  class ParkSystemsController < AdminController
    before_action :find_parksystem, only: %i[show index]
    def new
    ...
    def show
      ...
      return unless params[:id] && (params[:status] == 'remove')
